		...
		create: function() { 
			...
			if($this.schema) { 
				...
				$.each($this.data, function(key, row) { 
					...
					//creating tbody
					table += (key%2 == 0) ? '<tr class="ui-table-rows-even" data-id="' + row[$this.identifier] + '" data-dataset-id="' + row[$this.dataset] + '">' : '<tr class="ui-table-rows-odd" data-id="' + row[$this.identifier]  + '" data-dataset-id="' + row[$this.dataset] + '">'; 
			...
			var controls = {
				...
				"prev_page":prev, 
				"prev_text": '<img src="libs/jquery-columns-1.0/images/arrow-left.png">', 
				"next_page":next, 
				"next_text":'<img src="libs/jquery-columns-1.0/images/arrow-right.png">',
