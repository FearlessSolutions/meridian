...
/**
 * This is a modified copy of https://github.com/colorhook/jsxml
 * The original does not work because it forces namespaces for all printouts.
 */
...
(function() {
    ...
    merge(XMLList.prototype, {
         ...
         * @return String
         */
        toXMLString: function(indent) {
            var s = [];
            indent = indent || 0;
            this.each(function(item) {
                s.push(item.toXMLString(indent));
            });
            return s.join("\n");
        },
        /**
...
//                }
        ...
        toXMLString: function(indent) {
            indent = indent || 0;
            return this._toXMLString(indent, true);
        },
        /**
